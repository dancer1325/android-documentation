...
**Source:** [https://developer.android.com/build/build-analyzer](https://developer.android.com/build/build-analyzer)
...
![](/static/studio/images/build/build-analyzer/analyzer-overview.png) **Figure 1.** The Build Analyzer overview page gives a summary of the findings.
...
![](/static/studio/images/plugins-breakdown.png) **Figure 2.** The Build Analyzer provides a breakdown of plugins that affect your build's duration.
...
![](/static/studio/images/tasks-breakdown.png) **Figure 3.** The Build Analyzer provides a breakdown of tasks most responsible for your build's duration.
...
![](/static/studio/images/build/build-analyzer/inspect-warning.png) **Figure 4.** Detailed information about Build Analyzer warnings. 
...
The Build Analyzer reports the following warning types:
  ...
  * **Non-incremental annotation processor:** This warning is generated in situations where an annotation processor is non-incremental and causes the `JavaCompile` task to always run non-incrementally. To address this warning, [switch to an incremental annotation processor](/studio/build/optimize-your-build?utm_source=android-studio#incremental-annotation-processor-support).
...
Build Analyzer provides a summary of time spent downloading dependencies and a detailed view of downloads per repository. To check the impact of downloads, select **Downloads** from the dropdown. This info is also available in the [**Sync**](/studio/run#gradle-console) window.
...
![](/static/studio/images/build/build-analyzer/build-analyzer-download-impact.png) **Figure 5.** The Build Analyzer shows the impact of downloads on build duration. 

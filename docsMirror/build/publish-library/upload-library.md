...
**Source:** [https://developer.android.com/build/publish-library/upload-library](https://developer.android.com/build/publish-library/upload-library)
...
Publishing to a local repository is very similar to publishing to a remote repository, except for the repository declaration. Read the preceding section to learn how to publish to a remote repository to create a publication that publishes the desired variant or variants. Then create a local repository:

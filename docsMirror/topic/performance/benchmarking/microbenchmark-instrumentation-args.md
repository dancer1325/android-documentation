# Microbenchmark instrumentation arguments  |  App quality  |  Android Developers

**Source:** [https://developer.android.com/topic/performance/benchmarking/microbenchmark-instrumentation-args](https://developer.android.com/topic/performance/benchmarking/microbenchmark-instrumentation-args)
...
Counts the CPU events specified in `androidx.benchmark.cpuEventCounter.events`. Requires root access.
...
Configures how many measurements occur. This does not directly define the number of loops executed because each measurement typically runs many loops, defined dynamically based on run time during warmup.
...
Allows capturing trace files while running the benchmarks. See [Profile a Microbenchmark](/studio/profile/microbenchmark-profile) for available options.
...
[ Next Microbenchmark and Hilt  arrow_forward  ](/topic/performance/benchmarking/microbenchmark-and-hilt)

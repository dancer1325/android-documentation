...
**Source:** [https://developer.android.com/topic/performance/power/battery-historian](https://developer.android.com/topic/performance/power/battery-historian)
...
![Battery Historian’s display of system-wide events affecting power
  consumption.](/static/topic/performance/images/generic-timeline.png) **Figure 1.** Battery Historian’s display of system-wide events affecting power consumption. 
...
![A close-up of the Battery Historian timeline from roughly 6:50 AM to 7:20 AM.](/static/topic/performance/images/s-generic-closeup.png) **Figure 2.** A close-up of the Battery Historian timeline from roughly 6:50 AM to 7:20 AM. 
...
The system-wide visualization can provide other clues, as well. For instance, if it shows that the mobile radio is frequently being turned off and on, there may be an opportunity to optimize this behavior through [intelligent scheduling APIs](/topic/performance/scheduling) such as JobScheduler or Firebase Job Dispatcher.
...
To look up the data for a specific app, enter its package name into the lower of the two dropdown menus under _App Selection_ , located under the left side of the visualization.

![Entering a specific app whose data to view.](/static/topic/performance/images/dropdown.png) **Figure 4.** Entering a specific app whose data to view. 
...
You can also obtain one more piece of app-specific visualization data, _Userspace Wakelock_. To include this information in the bug report, enter the following command in your terminal window:
...
![Visualization of data for fictional app Pug Power.](/static/topic/performance/images/pug-visualization.png) **Figure 5.** Visualization of data for fictional app Pug Power. 

  
![Tabular data for the fictional Pug Power app.](/static/topic/performance/images/pugspecificdata.png)
...
However, examination of the _Wakelocks_ segment of the tabular data reveals that Pug Power acquires wakelocks totaling over an hour. This unusual and costly behavior can account for the app’s high level of power consumption. This piece of information helps the developer target an area where optimization is likely to greatly help. In this case, why does the app acquire so much wakelock time, and how can the developer ameliorate this behavior?

# Examples of performance measurement and analysis  |  App quality  |  Android Developers

**Source:** [https://developer.android.com/topic/performance/performance-measurement-examples](https://developer.android.com/topic/performance/performance-measurement-examples)
...
When possible, we recommend that you include a [`reportFullyDrawn`](/reference/android/app/Activity#reportFullyDrawn\(\)) call (available on Android 10 and higher) when startup is completed from the application’s perspective.

Some things to look for in these system traces include:

![Monitor contention](/static/topic/performance/images/benchmark_images/monitor_contention.png)   
...
The [Android Studio memory profiler](/studio/profile/memory-profiler) is a powerful tool to reduce memory pressure that could be caused by memory leaks or bad usage patterns. It provides a live view of object allocations and collections.

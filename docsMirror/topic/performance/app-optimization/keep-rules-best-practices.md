# Follow the best practices  |  App quality  |  Android Developers

**Source:** [https://developer.android.com/topic/performance/app-optimization/keep-rules-best-practices](https://developer.android.com/topic/performance/app-optimization/keep-rules-best-practices)
...
We recommend naming your annotations such that they provide meaningful context for why code parts are preserved. For example, use `@DisplayComponent` for an app where display components require some parts to be kept.
  ...
  * If you use the [`repackageclasses` global option](/topic/performance/app-optimization/global-options#global-options), avoid specifying the optional package name. This results in smaller DEX files because the package prefix is omitted in the repackaged class names.

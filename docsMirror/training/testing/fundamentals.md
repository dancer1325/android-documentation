...
**Source:** [https://developer.android.com/training/testing/fundamentals](https://developer.android.com/training/testing/fundamentals)
...
![Tests can be either small, medium, or big.](/static/training/testing/fundamentals/test-scopes.png) **Figure 1** : Test scopes in a typical application.
...
![Tests can run as instrumented tests on a device, or local tests on your development machine.](/static/training/testing/fundamentals/instru-vs-local.png) **Figure 2** : Different types of tests depending on where they run.
...
Alternatively, if you want to create your first test and learn by doing, check out the [Testing codelabs](/codelabs/advanced-android-kotlin-training-testing-basics).

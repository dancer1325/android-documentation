# Adaptive do's and don'ts  |  Jetpack Compose  |  Android Developers

**Source:** [https://developer.android.com/develop/ui/compose/layouts/adaptive/adaptive-dos-and-donts](https://developer.android.com/develop/ui/compose/layouts/adaptive/adaptive-dos-and-donts)
...
The [`resizeableActivity`](/guide/topics/manifest/activity-element#resizeableActivity) attribute of the [`<activity>`](/guide/topics/manifest/activity-element) and [`<application>`](/guide/topics/manifest/application-element) manifest elements enables or disables multi‑window mode on Android 11 (API level 30) and lower. On Android 12 (API level 31) and higher, large screens support multi‑window mode regardless of the attribute. For more information, see [Support multi-window mode](/develop/ui/compose/layouts/adaptive/support-multi-window-mode).

✓ Do

Enable your app to participate in multi‑window, multitasking scenarios for increased user productivity and satisfaction.
...
The [`screenOrientation`](/guide/topics/manifest/activity-element#screen) manifest setting restricts activity orientation.
...
The [`minAspectRatio`](/reference/android/R.attr#minAspectRatio) and [`maxAspectRatio`](/reference/android/R.attr#maxAspectRatio) manifest settings restrict your app's aspect ratio to hard‑coded values.
...
On Android 14 (API level 34) and higher, users can override the app aspect ratio to expand letterboxed apps to fill the available display area. See [Device compatibility mode](/guide/practices/device-compatibility-mode#user_per-app_overrides).
...
[Window size classes](/develop/ui/compose/layouts/adaptive/window-size-classes) provide a systematic way of determining and categorizing the size of the app window. Adapt your app by changing layouts as the window size class of your app changes.
...
Use [`WindowManager#getCurrentWindowMetrics()`](/reference/kotlin/android/view/WindowManager#getcurrentwindowmetrics) and [`WindowMetrics#getBounds()`](/reference/kotlin/android/view/WindowMetrics#getbounds) to get the size of the app window. Use [`WindowMetrics#getDensity()`](/reference/kotlin/android/view/WindowMetrics#getdensity) to get the display density.

✗ Don't

Don't use the following deprecated [`Display`](/reference/kotlin/android/view/Display) APIs to determine window size:

  * [`getSize()`](/reference/kotlin/android/view/Display#getsize): Deprecated in Android 11 (API level 30)
...
The [Compose Material 3 Adaptive library](/reference/kotlin/androidx/compose/material3/adaptive/package-summary) provides components and APIs that facilitate the development of adaptive apps.
...
Your browser doesn't support the video tag.  ✓ Do: List and detail activities organized in a dual-pane layout. 

✗ Don't

If you're not using content panes, don't just stretch UI elements to fill available display space. Long lines of text are difficult to read. Stretched buttons look poorly designed. If you use [`Modifier.fillMaxWidth`](/reference/kotlin/androidx/compose/foundation/layout/fillMaxWidth.modifier#\(androidx.compose.ui.Modifier\).fillMaxWidth\(kotlin.Float\)), don't assume that's the right behavior for all display sizes.
...
Take advantage of the built‑in functionality of the Android framework for keyboard tab navigation and mouse or trackpad click, select, and scroll. Publish your app's keyboard shortcuts in [Keyboard Shortcuts Helper](/develop/ui/compose/touch-input/keyboard-input/keyboard-shortcuts-helper).

Use the Jetpack [Material 3 library](/reference/kotlin/androidx/compose/material3/package-summary) to enable users to write into any [`TextField`](/reference/kotlin/androidx/compose/material/TextField.composable#TextField\(androidx.compose.ui.text.input.TextFieldValue,kotlin.Function1,androidx.compose.ui.Modifier,kotlin.Boolean,kotlin.Boolean,androidx.compose.ui.text.TextStyle,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Boolean,androidx.compose.ui.text.input.VisualTransformation,androidx.compose.foundation.text.KeyboardOptions,androidx.compose.foundation.text.KeyboardActions,kotlin.Boolean,kotlin.Int,kotlin.Int,androidx.compose.foundation.interaction.MutableInteractionSource,androidx.compose.ui.graphics.Shape,androidx.compose.material.TextFieldColors\)) component using a stylus.
...
[ Previous arrow_back  Support multi-window mode  ](/develop/ui/compose/layouts/adaptive/support-multi-window-mode)

[ Next Use window size classes  arrow_forward  ](/develop/ui/compose/layouts/adaptive/use-window-size-classes)

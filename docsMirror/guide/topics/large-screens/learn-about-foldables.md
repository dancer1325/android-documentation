...
**Source:** [https://developer.android.com/guide/topics/large-screens/learn-about-foldables](https://developer.android.com/guide/topics/large-screens/learn-about-foldables)
...
Support for foldable devices begins with responsive design. Responsive layouts enable an app to look and work great on a range of display sizes. Implement responsive design with the [`BoxWithConstraints`](/reference/kotlin/androidx/compose/foundation/layout/BoxWithConstraints.composable#BoxWithConstraints\(androidx.compose.ui.Modifier,androidx.compose.ui.Alignment,kotlin.Boolean,kotlin.Function1\)) composable.
...
![](/static/develop/ui/compose/images/layouts/adaptive/foldables/foldable_postures_flat_and_half_opened.png) **Figure 3.** Foldable device in flat and half-opened states. 
...
For more information about folds and foldable postures, see [Make your app fold aware](/develop/ui/compose/layouts/adaptive/foldables/make-your-app-fold-aware).

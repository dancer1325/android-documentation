# Integrate asset delivery (Kotlin and Java)  |  Other Play guides  |  Android Developers

**Source:** [https://developer.android.com/guide/playcore/asset-delivery/integrate-java](https://developer.android.com/guide/playcore/asset-delivery/integrate-java)
...
The following [`AssetPackState`](/reference/com/google/android/play/core/assetpacks/AssetPackState) methods provide the size of the asset pack, the downloaded amount so far (if requested), and the amount already transferred to the app:

...
**Source:** [https://developer.android.com/about/versions/17/setup-sdk](https://developer.android.com/about/versions/17/setup-sdk)
...
Android Studio can provide contextual information about the behavior changes through the [Android SDK Upgrade Assistant](/r/studio-ui/ide/android-sdk-upgrade-assistant). Once you're ready to opt in to the new runtime behaviours for Android 17, update your app's `targetSdk` as follows: Groovy
...
Manually install the SDK Within Android Studio, you can install the Android 17 SDK as follows:
...
Next steps To learn about the changes that might affect your app, and to learn how to test these changes in your app, read the following topics:

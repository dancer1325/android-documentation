...
**Source:** [https://developer.android.com/studio/test/other-testing-tools/monkey](https://developer.android.com/studio/test/other-testing-tools/monkey)
...
`--hprof` | If set, this option will generate profiling reports immediately before and after the Monkey event sequence. This will generate large (~5Mb) files in data/misc, so use with care. For information on analyzing profiling reports, see [Profile your app performance](/studio/profile).  

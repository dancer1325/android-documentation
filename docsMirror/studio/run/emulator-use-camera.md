# Camera support  |  Android Studio  |  Android Developers

**Source:** [https://developer.android.com/studio/run/emulator-use-camera](https://developer.android.com/studio/run/emulator-use-camera)
...
Before using macros, follow the steps in [Run AR apps in Android Emulator](https://developers.google.com/ar/develop/java/emulator) to set up the virtual scene camera for your app, run your app on the emulator, and update ARCore. Then, follow these steps to use emulator macros:
  ...
  1. With the emulator running and your app connected to ARCore, click **More** ![](/static/studio/images/buttons/emulator-extended-controls.png) in the emulator panel.

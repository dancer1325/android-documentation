...
**Source:** [https://developer.android.com/studio/intro/new-ui](https://developer.android.com/studio/intro/new-ui)
...
![](/static/studio/images/new-ui/light-theme.png) **Figure 1.** The **Light** theme for the New UI.

### Light with Light Header

![](/static/studio/images/new-ui/light-with-light-theme.png) **Figure 2.** The **Light with Light Header** theme for the New UI.

### Dark

![](/static/studio/images/new-ui/dark-theme.png) **Figure 3.** The **Dark** theme for the New UI.
...
![](/static/studio/images/new-ui/themes-and-icons.png) **Figure 4.** The icon set for the New UI.
...
![](/static/studio/images/new-ui/classic-toolbar.png) **Figure 5.** The Classic UI.
...
![](/static/studio/images/new-ui/custom-toolbar.png) **Figure 7.** Settings to customize your main toolbar.
...
![](/static/studio/images/new-ui/project-widget.png) **Figure 8.** The location of the Project Widget in the main toolbar.
...
![](/static/studio/images/new-ui/git-widget.png) **Figure 9.** The location of the Git Widget in the main toolbar.
...
![](/static/studio/images/new-ui/classic-run-config.png) **Figure 10.** Run configurations in the Classic UI.
...
Alas, your browser doesn't support HTML5 video. That's okay! You can still [download the video](/static/studio/images/new-ui/tool-windows-overflow.mp4) and watch it with a video player.  **Figure 13.** The location of the tool windows overflow menu in the new UI.
...
![](/static/studio/images/new-ui/classic-ui-tool.png) **Figure 16.** UI Tool Controls in the Classic UI. ![](/static/studio/images/new-ui/new-ui-tool.png) **Figure 17.** UI Tool Controls in the New UI.
...
![](/static/studio/images/new-ui/new-nav-bar.png) **Figure 18.** The navigation bar in the New UI.
...
![](/static/studio/images/new-ui/compact-full.png) **Figure 19.** Android Studio window in Compact Mode. ![](/static/studio/images/new-ui/compact-toolbar.png) **Figure 20.** Toolbar height in Compact Mode.

### Off

![](/static/studio/images/new-ui/default-full.png) **Figure 19a.** Android Studio window in the default mode. ![](/static/studio/images/new-ui/default-toolbar.png) **Figure 20a.** Toolbar height in the default mode.

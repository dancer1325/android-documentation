...
**Source:** [https://developer.android.com/studio/command-line/logcat](https://developer.android.com/studio/command-line/logcat)
...
There is also a shorthand of `adb logcat`, but that just expands to `adb shell logcat`.
...
To reduce the log output to a manageable level, restrict log output using _filter expressions_. Filter expressions let you indicate to the system the tag-priority combinations that you are interested in. The system suppresses other messages for the specified tags.
...
The `[Log](/reference/android/util/Log)` class lets you create log entries in your code that display in the `logcat` tool. Common logging methods include:
  ...
  * `[ Log.v(String, String)](/reference/android/util/Log#v\(java.lang.String, java.lang.String\))` (verbose)
  * `[ Log.d(String, String)](/reference/android/util/Log#d\(java.lang.String, java.lang.String\))` (debug)

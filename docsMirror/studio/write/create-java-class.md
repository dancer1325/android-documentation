...
**Source:** [https://developer.android.com/studio/write/create-java-class](https://developer.android.com/studio/write/create-java-class)
...
In the [template list](https://www.jetbrains.com/help/idea/2026.1/settings-file-and-code-templates.html), internal template names are in bold font. Customized template names are displayed in a highlight color, such as blue.
...
The default depends on how you launched the **Create New Class** dialog. If you first selected a Java file or folder in the **Project** window, the default is the package for the item you selected. If you first clicked in a Java file in the Code Editor, the default is the package that contains this file.
     ...
     * **Show Select Overrides Dialog** \- For a **Kind** of **Class** , check this option to open the [Select Methods to Override/Implement dialog](https://www.jetbrains.com/help/idea/2026.1/overriding-methods-of-a-superclass.html) after you click **OK**. In this dialog, you can select methods that you would like to override or implement, and Android Studio will generate skeleton code for these methods.

# Build and run a profileable app manually  |  Android Studio  |  Android Developers

**Source:** [https://developer.android.com/studio/profile/build-run-manually](https://developer.android.com/studio/profile/build-run-manually)
...
To convert your release app to a profileable app, do the following:
  ...
  1. Open the `AndroidManifest.xml` file and adding the following within `<application>`. For more details, see [Build your app for release](/studio/publish/preparing#publishing-build). 

# Top down and bottom up charts  |  Android Studio  |  Android Developers

**Source:** [https://developer.android.com/studio/profile/chart-glossary/top-bottom-charts](https://developer.android.com/studio/profile/chart-glossary/top-bottom-charts)
...
As shown in Figure 2, expanding the node for method A in the **Top Down** tab displays its callees, methods B and D. After that, expanding the node for method D exposes its callees, such as methods B and C. Similar to the [**Flame chart**](/studio/profile/chart-glossary/flame-chart) tab, the top down tree aggregates trace information for identical methods that share the same call stack. That is, the **Flame chart** tab provides a graphical representation of the **Top Down** tab.

...
**Source:** [https://developer.android.com/studio/profile/record-native-allocations](https://developer.android.com/studio/profile/record-native-allocations)
...
When you run the [**Track Memory Consumption (Native Allocations)**](/studio/profile#start-profiling) task, the Android Studio Profiler tracks allocations and deallocations of objects in native code for the time period that you specify and provides the following information:

...
**Source:** [https://developer.android.com/studio/intro](https://developer.android.com/studio/intro)
...
![](/static/studio/images/project-android-view.png)
...
To learn more about the build system and how to configure your build, see [Configure your build](/build).
...
For more information about configuring build variants, see [Configure build variants](/build/build-variants).

### Resource shrinking

Resource shrinking in Android Studio automatically removes unused resources from your packaged app and library dependencies. For example, if you add an image or string to your project but never actually reference it in your UI, resource shrinking safely removes that asset from your packaged app.

**Note:** Resource shrinking works in conjunction with code shrinking tools, such as R8.

For more information on shrinking code and resources, see [Enable app optimization with R8](/topic/performance/app-optimization/enable-app-optimization).
...
For more information about configuring dependencies, read [Add build dependencies](/build/dependencies).
...
Layout Inspector lets you inspect a Compose layout inside a running app in an emulator or physical device. You can use the Layout Inspector to check how often a composable is recomposed or skipped, which can help identify issues with your app.

To start the Layout Inspector, [run your app](/studio/run), go to the **Running Devices** window, and click **Toggle Layout Inspector** ![](/static/studio/images/design/start-embedded-layout-inspector.png). If you switch among multiple devices or projects, the Layout Inspector automatically connects to the debuggable processes running in the foreground of the connected device.

For more information, see [Layout Inspector](/studio/debug/layout-inspector).
...
For more information about performance profilers, see [Profile your app performance](/studio/profile).
...
For more information about working with heap dumps, see [Capture a heap dump](/studio/profile/capture-heap-dump).
...
For information about tracking and analyzing allocations, see [Heap dump overview](/studio/profile/capture-heap-dump#heap-dump-overview).

### Data file access

The Android SDK tools, such as [Systrace](/topic/performance/tracing/command-line) and [Logcat](/studio/debug/am-logcat), generate performance and debugging data for detailed app analysis.
...
![](/static/studio/images/lint-inspection-results.png)
...
For more information, see [Improve your code with lint checks](/studio/write/lint).
...
For more details about Android annotations, see [Improve code inspection with annotations](/studio/write/annotations).

### Log messages

When you build and run your app with Android Studio, you can view [`adb`](/studio/command-line/adb) output and device log messages in the [**Logcat** window](/studio/debug/am-logcat).

## Sign in to your developer account

Sign in to your developer account in Android Studio to access additional tools that require authentication, such as Firebase and Android Vitals in [App Quality Insights](/studio/debug/app-quality-insights) and [Gemini in Android Studio](/studio/preview/gemini). By signing in, you give those tools permission to view and manage your data across Google services.

To sign in to your developer account in Android Studio, click the profile icon ![](/static/studio/images/intro/profile-icon.png) at the end of the toolbar. Follow the prompts to provide the IDE with only the permissions required for each feature you want to enable. If you're already signed in, manage the permissions at **File** (**Android Studio** on macOS) > **Settings** > **Tools** > **Google Accounts**.

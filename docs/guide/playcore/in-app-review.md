...
**Source:** [https://developer.android.com/guide/playcore/in-app-review](https://developer.android.com/guide/playcore/in-app-review)
...
**Note:** To protect user privacy and avoid API misuse, there are strict guidelines that your app should follow about when to request in-app reviews and the design of the review prompt.
...
By accessing or using the Play In-App Reviews Library, you agree to the [Play Core Software Development Kit Terms of Service](/guide/playcore#license). Read and understand all applicable terms and policies before accessing the library.

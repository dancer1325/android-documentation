# Performance class  |  App quality  |  Android Developers

**Source:** [https://developer.android.com/topic/performance/performance-class](https://developer.android.com/topic/performance/performance-class)
...
To find a device's performance class level, use the Jetpack [Core Performance](/jetpack/androidx/releases/core#core_performance_version_10_2) library. This library reports the device's media performance class (MPC) level as declared in the [build version information](/reference/android/os/Build.VERSION#MEDIA_PERFORMANCE_CLASS) or based on data from Google Play services.
...
Then, create an instance of a [`DevicePerformance`](/reference/androidx/core/performance/DevicePerformance) implementation, such as [`PlayServicesDevicePerformance`](/reference/androidx/core/performance/play/services/PlayServicesDevicePerformance), in the `onCreate()` lifecycle event of your `Application`. This should only be done once in your app.

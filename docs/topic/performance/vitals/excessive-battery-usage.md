# Excessive battery usage  |  App quality  |  Android Developers

**Source:** [https://developer.android.com/topic/performance/vitals/excessive-battery-usage](https://developer.android.com/topic/performance/vitals/excessive-battery-usage)
...
[Watch Face Format](/training/wearables/wff) uses declarative XML instead of executable code to simplify app creation and reduces battery usage.

### Handle Always on display (AoD) mode

When a watch isn't in use it switches to Always-on display (AoD), also called ambient mode. In AoD, your watch face should [illuminate no more than 15% of pixels](/docs/quality-guidelines/wear-app-quality#always-on-display).
...
[ Next Permission Denials  arrow_forward  ](/topic/performance/vitals/permissions)

...
**Source:** [https://developer.android.com/topic/performance/memory-management](https://developer.android.com/topic/performance/memory-management)
...
![Types of memory](/static/images/games/memory-types.svg)
...
RAM is broken up into _pages_. Typically each page is 4KB of memory.

Pages are considered either _free_ or _used_. Free pages are unused RAM. Used pages are RAM that the system is actively using, and are grouped into the following categories:
...
`kswapd` can reclaim clean pages by deleting them because they're backed by storage and have not been modified. If a process tries to address a clean page that has been deleted, the system copies the page from storage to RAM. This operation is known as _demand paging_.

![Clean page backed by storage deleted](/static/images/games/delete-clean-page.svg)
...
![Android processes, high scores at the top](/static/images/games/lmk-process-order.svg)
...
![Pages used by different processes](/static/images/games/pages-processes.svg)
...
![Pages shared by two apps](/static/images/games/pages-shared-apps.svg)

# Profile pre-built APKs  |  Android Studio  |  Android Developers

**Source:** [https://developer.android.com/studio/profile/apk-profiler](https://developer.android.com/studio/profile/apk-profiler)
...
#  Profile pre-built APKs Stay organized with collections  Save and categorize content based on your preferences. 
...
![Importing a pre-built APK into Android Studio](/static/studio/images/debug/import_apk-2X.png)
...
The native source files appear in the **Project** window. Open those native source files to add breakpoints and [debug your app](/studio/debug). To remove the mappings, click **Clear** in the **Path Mappings** section of the editor window.
...
![Import updated APK](/static/studio/images/debug/import-updated-apk.png)

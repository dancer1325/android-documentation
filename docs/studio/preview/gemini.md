...
**Source:** [https://developer.android.com/studio/preview/gemini](https://developer.android.com/studio/preview/gemini)
...
If you're an individual freelance developer, student, or hobbyist, we recommend the Gemini in Android Studio [free edition](/studio/gemini/feature-comparison#individuals). At no cost, you get access to a lightweight version of Gemini with a small context window, which is appropriate for most tasks. If you need to execute more complex tasks that would benefit from Gemini Pro's full 1M token context window, you can [add a Gemini API key](/studio/gemini/add-api-key) and pay per token.

Or you can [subscribe to Google One](https://one.google.com/about/) and get 2 TB or more of cloud storage, higher rate limits, and additional benefits such as Gemini in Google Docs and Gmail, access to Veo, and higher usage limits on products like Nano Banana and NotebookLM. [Find the right Google One plan for you](https://one.google.com/intl/en_us/about/google-ai-plans/#compare-plans).

**Note:** If you already subscribe to Google One, you automatically get the Gemini in Android Studio added capabilities and benefits at no additional cost.
...
Gemini in Android Studio is under active development and updates frequently! You can learn about the latest AI features and other preview features by checking out the [Android Studio preview release notes](/studio/preview/features) and by [downloading a preview](/studio/preview).

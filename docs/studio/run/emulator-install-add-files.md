...
**Source:** [https://developer.android.com/studio/run/emulator-install-add-files](https://developer.android.com/studio/run/emulator-install-add-files)
...
To add a file to the emulated device, drag the file onto the emulator screen. The file is placed in the `/sdcard/Download/` directory. You can view the file from Android Studio using the [Device Explorer](/studio/debug/device-file-explorer) or find it from the device using the **Downloads** or **Files** app, depending on the device version.

...
**Source:** [https://developer.android.com/studio/run/win-usb](https://developer.android.com/studio/run/win-usb)
...
There are two ways to download the Google USB Driver for Windows:
  ...
  * Get it from the [Android SDK Manager](/studio/intro/update#sdk-manager) as follows: 
    1. In Android Studio, click **Tools > SDK Manager**.
    2. Click the **SDK Tools** tab.
    3. Select **Google USB Driver** and click **OK**.

![SDK Manager
    with the Google USB Driver selected](/static/studio/images/run/sdk-manager-google-usb-driver.png)
...
Download the Google USB driver  [Download the Google USB driver ](https://dl.google.com/android/repository/usb_driver_r13-windows.zip)

_latest_usb_driver_windows.zip_

...
**Source:** [https://developer.android.com/studio/debug/am-logcat](https://developer.android.com/studio/debug/am-logcat)
...
![The Logcat window UI](/static/studio/images/debug/logcat-window.png)
...
The standard log view displays each log's date, time process and thread ID, tag, package name, priority, and the message associated with it. By default, message lines are not wrapped in the log view but you can use the **Soft-Wrap** ![Soft-Wrap icon](/static/studio/images/buttons/logcat-soft-wrap.png) option from the Logcat toolbar.

You can switch to **Compact** view, which has less default display information, by clicking **Configure Logcat Formatting Options** ![](/static/studio/images/buttons/logcat-formatting-options.png) from the **Logcat** toolbar.
...
Tabs help you easily switch between different devices or queries. You can create multiple Logcat tabs by clicking **New Tab** ![New Tab icon](/static/studio/images/buttons/logcat-new-tab.png). Right-clicking a tab lets you rename and rearrange it.
...
![Multiple Logcat windows](/static/studio/images/debug/logcat-split-view.png) **Figure 2.** Split **Logcat** windows in Android Studio.
...
![List of suggestions in the query field](/static/studio/images/debug/logcat-query-suggestions.png) **Figure 3.** Press `Ctrl` \+ `Space` in the query field to see a list of suggested queries.
...
You can view your query history by clicking **Show history** ![Filter icon](/static/studio/images/buttons/logcat-filter-icon.png) next to the query field. To favorite a query so that it stays at the top of the list across all your studio projects, click the star next to it. You can also use the `name:` key to make favorite queries more easy to recognize. For more information, see Special queries.

![UI for favoriting a query](/static/studio/images/debug/logcat-fav-query.png)
...
![Logcat window for app crashes](/static/studio/images/debug/logcat-track-crashes.png)

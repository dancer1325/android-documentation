# Configure test fixtures for publication  |  Android Studio  |  Android Developers

**Source:** [https://developer.android.com/build/publish-library/configure-test-fixtures](https://developer.android.com/build/publish-library/configure-test-fixtures)

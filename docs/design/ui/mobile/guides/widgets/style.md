# Style  |  Mobile  |  Android Developers

**Source:** [https://developer.android.com/design/ui/mobile/guides/widgets/style](https://developer.android.com/design/ui/mobile/guides/widgets/style)
...
![Widget with color tokens called out.](/static/images/design/ui/mobile/widgets/widgets_expressive_color.png) Use color to define a visual hierarchy for new content for a more expressive widget.
...
The shape of your widget sets the mood of your widget. For rectangular widgets, use the [system corner radius property](/reference/android/R.dimen#system_app_widget_background_radius). This property creates consistency across different devices and helps prevent widget content from being clipped.
...
![Widgets using different shapes](/static/images/design/ui/mobile/widgets/widgets_expressive_shape.png) A widget in an expressive shape and a rectangular widget using expressive shapes for visual hierarchy.

To learn more, see [Implement rounded corners](/develop/ui/views/appwidgets#rounded-corner).
...
![](/static/images/design/ui/mobile/widgets/01_Dynamic_theme.jpg) Image of a widget with color tokens called out.
...
![](/static/images/design/ui/mobile/widgets/02_Light_and_Dark.jpg) A widget in light mode on the left screen and dark on the right.
...
![](/static/images/design/ui/mobile/widgets/03_Typography.jpg) A widget showing the use of different type scales.
...
![](/static/images/design/ui/mobile/widgets/widgets_expressive_type.png) A widget combining expressive techniques and using large expressive type.
